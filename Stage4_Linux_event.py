...
zone = 'z26'
root = 'G:/event_fireharm/'
prep = 'G:/event_prep/'
emds = ''
infiles = '/mnt/pvfs2/jherynk/event/' + zone + '/infiles/'
outfiles = '/mnt/pvfs2/jherynk/event/' + zone + '/outfiles/'
batLoc = '/mnt/pvfs2/jherynk/event/' + zone
mode = 'e'
workingdir =   infiles
...
def createInFiles():
    for chunk in res:
        ...
        infile.write("""         2           Simulation option (1-simulate for entire wx record, 2-simulated for wx condition)
...
def createBashFile():
    ...
    infile.write('datadir=/mnt/pvfs2/jherynk/event/' + zone + '\n')
    infile.write('cd ${datadir}\n')
    directions = """
qsub -cwd -S /bin/bash ./%s_00.bat
qsub -cwd -S /bin/bash ./%s_01.bat
qsub -cwd -S /bin/bash ./%s_02.bat
qsub -cwd -S /bin/bash ./%s_03.bat
qsub -cwd -S /bin/bash ./%s_04.bat
qsub -cwd -S /bin/bash ./%s_05.bat
qsub -cwd -S /bin/bash ./%s_06.bat
qsub -cwd -S /bin/bash ./%s_07.bat
qsub -cwd -S /bin/bash ./%s_08.bat
qsub -cwd -S /bin/bash ./%s_09.bat
qsub -cwd -S /bin/bash ./%s_10.bat
qsub -cwd -S /bin/bash ./%s_11.bat
qsub -cwd -S /bin/bash ./%s_12.bat
qsub -cwd -S /bin/bash ./%s_13.bat
qsub -cwd -S /bin/bash ./%s_14.bat
qsub -cwd -S /bin/bash ./%s_15.bat
