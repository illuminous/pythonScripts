...
query="""SELECT classified_FLM_single_condition.System_group_Code, classified_FLM_single_condition.FLM, Count(classified_FLM_single_condition.FLM) AS CountOfFLM
FROM classified_FLM_single_condition
GROUP BY classified_FLM_single_condition.System_group_Code, classified_FLM_single_condition.FLM;
...
#open an outfile
outfile = open("C:/temp/evtGrouped.csv",'w') 

#write a header - turn this off if reading into Arc Info table
outfile.write("EVTg,FLM,Count\n")
