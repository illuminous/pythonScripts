...
query="""SELECT tbl_Products.VEG_evt, tbl_fire_effects_FLM.FLM, Count(tbl_fire_effects_FLM.FLM) AS CountOfFLM
FROM tbl_fire_effects_FLM INNER JOIN tbl_Products ON tbl_fire_effects_FLM.Master_ID=tbl_Products.Master_ID
GROUP BY tbl_Products.VEG_evt, tbl_fire_effects_FLM.FLM
...
#open an outfile
outfile = open("C:/AWORKSPACE/flm_workspace/flm_production/Python_Majority_Outfiles/evt.csv",'w') 
