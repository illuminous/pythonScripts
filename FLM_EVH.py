...
query="""SELECT classified_FLM_single_condition.EVT_value, classified_FLM_single_condition.EVH_Breaks, classified_FLM_single_condition.FLM, Count(classified_FLM_single_condition.FLM) AS CountOfFLM
FROM classified_FLM_single_condition
GROUP BY classified_FLM_single_condition.EVT_value, classified_FLM_single_condition.EVH_Breaks, classified_FLM_single_condition.FLM;
...
#open an outfile
outfile = open("C:/temp/evt_evh.csv",'w') 

#write a header - turn this off if reading into Arc Info table
outfile.write("EVT,EVH,FLM,Count\n")
