...
gp.workspace = "f:/landcover/analysis5/tables"
res = []
...
####        gp.select_analysis("CA_CA_002_0", output,  command)
...
##        gp.TableToDbase_conversion(newname, "f:/landcover/analysis5/tables")
##
##    except:
...
##        print gp.GetMessages()
    ...
    db = dbf.Dbf('f:/landcover/analysis5/tables/intersect_%s_%s.dbf' %(year,thread))
...
newfile = open('f:/landcover/analysis5/tables/Results.txt', 'w')
