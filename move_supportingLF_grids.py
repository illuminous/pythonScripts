...
products = ['cbd', 'cbh', 'flm', 'frcc', 'mfri', 'pls', 'prs', 'fbfm40]
zoneres = []

rootdata = 'K://lib//landfire//national' 
wsdata = 'H:/biosOriginal' 
structure1 = '/%s'
...
def copyFLM():
    for zone in zoneres:
        for p in products:
            ...
            InRaster2 = rootdata + '/%s/%s_bio/gis/%s_%s' %(zone,zone,zone, p)
            print InRaster2
