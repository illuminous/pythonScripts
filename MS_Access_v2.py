...
data_source = "C:/treelists/treelist_archive/z01/treelistshell_median_z01.mdb"

query1 = "Select tbl_TL_Median_Grid.Species_ID \
          FROM tbl_TL_Median_Grid \
          WHERE (((tbl_TL_Median_Grid.Species_ID)Like '***SPP'));"

query2 = "SELECT Count(tbl_TL_Median_Grid.VALUE) AS CountOfVALUE \
          FROM tbl_TL_Median_Grid;"
...
class AccessDb:
    ...
    ### originial def __init__(self, data_source, user, pwd="''", mdw="''"):
