...
zones = ['EA_IL', 'EA_IN', 'NW_WA', 'SA_PR','CA_CA', 'EA_IA', 'EA_MI', 'EA_MN', 'EA_MO', 'EA_NH', 'EA_NJ', 'EA_OH', 'EA_PA', 'EA_WI', 'EA_WV', 'GB_ID', 'GB_NV', 'GB_UT', 'GB_WY', 'NR_ID','NR_MT', 'NR_ND', 'NW_OR', 'MW_WA', 'RM_CO', 'RM_KS', 'RM_NE', 'RM_SD', 'RM_WY', 'SA_AL', 'SA_AR', 'SA_FL', 'SA_GA', 'SA_KY', 'SA_LA', 'SA_MD','SA_MS', 'SA_NC', 'SA_OK', 'SA_SC', 'SA_TN', 'SA_TX', 'SA_VA', 'SW_AZ', 'SW_NM', 'SW_TX'] #these are FPUs
...
for zone in zones:
    ...
    for name in names:
        ...
        try:
            ...
            OutRaster = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_o' % (zone, name)
            IntRaster = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_i' % (zone, name)
            OutRaster2 = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_2' % (zone, name)
            OutRaster3 = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_c' % (zone, name)
            OutRaster4 = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_pb' % (zone, name)
            kms = 'C:\\working\\FPA\\PBR_Raster_clip2\\%s%s_c' % (zone, name)
